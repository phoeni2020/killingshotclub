                    ...
                    <div class="col-lg-10">
                        <div class="card" style="zoom: 1;">
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    <form class="form" id="myForm" action="{{route('package.store')}}" method="POST"
                                            ...
                                            <div class="row targetDiv" id="div0">
                                                <div class="col-md-12">
                                                    <div id="group1" class="fvrduplicate">
                                                        @if (old('price_list_id'))
                                                            @foreach (old('price_list_id') as $key => $value)
                                                                <div class="row entry">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group price_row">
                                                                            ...
                                                                            <input class="form-control form-control-sm price" name="price[]" type="number" placeholder="سعر اللعبه" value="{{ old('price.' . $key) }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label>عدد التمرينه</label>
                                                                            <input class="form-control form-control-sm num_of_training" name="number_of_training[]" type="number" onchange="getTotal(this)" placeholder="عدد التمرينات" value="{{ old('number_of_training.' . $key) }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <div class="form-group">
                                                                            <label>اجمالي سعر التمرينه</label>
                                                                            <input class="form-control form-control-sm total_amount" name="total_of_training[]" type="number" placeholder="اجمالي سعر التمرينه" value="{{ old('total_of_training.' . $key) }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-1 mt-2">
                                                                        @if ($key == count(old('price_list_id'))-1)
...
@section('script')
    ...
    <script>
        var old_values  = @json(old('price_list_id'));
