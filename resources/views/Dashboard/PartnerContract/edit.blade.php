                    ...
                    <div class="col-lg-10">
                        <div class="card" style="zoom: 1;">
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    <form class="form" id="myForm" action="{{route('partner-contract.update',$partnerContract->id)}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="name"  required value="{{$partnerContract->name}}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="percentage"  required value="{{$partnerContract->percentage}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class=" form-control" id="" name="branch_id" >
                                                            @foreach($branches as $branch)
                                                                <option @if($partnerContract->branch_id==$branch->id) selected @endif value="{{$branch->id}}">{{$branch->name}}</option>
