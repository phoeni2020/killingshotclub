                                    ...
                                    <form class="form" action="{{route('role.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row" id="permissionID" style="display: none;">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="checkbox">
                                                    <h5 for="">اللاعبين</h5>
                                                    <label><input name="permession[]" type="checkbox"
                                                                  value="player-create"/>انشاء</label>
                                                </div>
                                                <div class="checkbox">
                                                    <label><input name="permession[]" type="checkbox"
                                                                  value="player-update"/>تعديل</label>
                                                </div>
                                                <div class="checkbox">
                                                    <label><input name="permession[]" type="checkbox"
                                                                  value="player-read"/>عرض</label>
                                                </div>
                                                <div class="checkbox">
                                                    <label><input name="permession[]" type="checkbox"
                                                                  value="player-delete"/>حذف</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <div class="checkbox">
