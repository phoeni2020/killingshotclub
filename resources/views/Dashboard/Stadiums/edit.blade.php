                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number"  class="form-control hour_rate"  value="{{ $stadium->hour_rate }}" id="hour_rate" disabled name="hour_rate">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label> سعر ساعه الايجار المثبت</label>
                                                        <input type="number"  class="form-control hour_rate"
                                                               value="{{ $stadium->hour_fixed_rate }}"
                                                               disabled name="hour_fixed_rate">
                                                    </div>
                                                </div>
